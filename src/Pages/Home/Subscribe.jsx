        ...
        <section className="text-gray-600 body-font px-4 py-4 lg:py-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
            <div className="md:flex justify-around items-center gap-4 py-12 px-3 bg-my-card rounded-lg" data-aos="fade-right" data-aos-duration="1000">
                ...
                <div>
                    ...
                    <div className="join">
                        <input type="email" value={email} onChange={handleEmail} className="input input-warning input-bordered join-item w-full" placeholder="Email" required />
                        <button className="btn btn-warning join-item rounded-r-full capitalize" onClick={handleSubmit}>Subscribe</button>
                    </div>
                </div>
            </div>
        </section>
